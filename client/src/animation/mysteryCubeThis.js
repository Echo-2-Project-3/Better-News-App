...
// import mysteryCubeHTML from "./mysteryCube.html";
import "./mysteryCube.css";
import "./mysteryCube.js"
...
class mysteryCube extends Component {
...
<div id="wrapper" >
    <div className="viewport">
      <div className="cube">
        ...
        <div className="side">
          <div className="cube-image active">?</div>
        </div>
      </div>
    </div>
  </div>
